      ...
      >
        ...
        <motion.div variants={itemVariants} className="px-4 -mt-2 relative z-20">
          <div className="grid grid-cols-3 gap-3">
            <div className="stat-card hover:scale-[1.02] active:scale-[0.98] transition-transform cursor-pointer bg-slate-900/40  border border-slate-700/50 rounded-2xl py-3 px-2 text-center text-white relative overflow-hidden group">
