...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const mockUser: User = {
    ...
    industry: "Tech",
    skills: "React, Node",
    networkingGoal: "networking",
    linkedinUrl: null,
    portfolioUrl: null,
    professionalMotto: "Build cool stuff",
    vibeStatus: "chill",
    currentActivity: "coding",
    icebreaker: "Hello world",
    weekendVibe: "relaxing",
    ...
    mbti: "INTJ",
    perfectDate: null,
    lifestyleCoffee: "daily",
    lifestyleAlcohol: "rarely",
    lifestyleSchedule: "flexible",
    bannerPhoto: null,
    isPublic: true,
    businessPhone: "555-0100",
    businessService: "AI Solutions",
    businessNeed: "Clients",
