      ...
      <DialogContent className="sm:max-w-md p-0 overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center">
            ...
            <div>
              <h3 className="font-medium text-gray-800">Real-Life Bumps</h3>
              <p className="text-sm text-gray-500 mt-1">Come within 3 miles to "bump" and start talking</p>
            </div>
          </div>
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Select "Bump" for hanging out or "Grind" for more</p>
            </div>
          </div>
