      ...
      <DialogContent className="sm:max-w-md p-0 bg-slate-900 border border-slate-700/50 max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-5">
          {[
            ...
            { icon: Heart, color: "text-rose-400", bg: "from-rose-500/20 to-rose-500/5", title: "Choose Your Category", desc: "Dating, Business, or Friendships — bump with people who match your vibe" },
